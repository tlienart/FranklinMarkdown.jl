...
function find_tokens(
    ...
    #
    @timeit_debug TIMER "tok/simple" begin
        ...
        if !isempty(simple_templates)
            ...
            @timeit_debug TIMER "regexmatch" begin
                simple_matches = eachmatch(rx, s)
            end
            @timeit_debug TIMER "regexproc" begin
    ...
    #
    @timeit_debug TIMER "tok/compl" begin
    ...
    @timeit_debug TIMER "tok/pp" begin
